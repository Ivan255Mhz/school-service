    ...
    return (
      <div className="dashboard">
        ...
        <div className="section-header">
          <h2>Уроки модуля</h2>
          <button onClick={() => setShowCreateLesson(true)} className="btn btn-primary btn-sm">
            + Добавить урок
          </button>
        </div>
        ...
        {showCreateLesson && (
          <form onSubmit={handleCreateLesson} className="create-form">
            ...
            <div className="form-actions">
              ...
              <button type="button" onClick={() => { setShowCreateLesson(false); setNewMaterials([]); }} className="btn btn-outline btn-sm">
                Отмена
              </button>
            </div>
          </form>
        ...
        {lessons.length === 0 ? (
          ...
          <div className="lessons-list">
            {lessons.map(lesson => {
              ...
              const attCount = Object.values(attendanceMap[lesson.id] || {}).filter(Boolean).length
      ...
      <div className="dashboard">
        ...
        {activeTab === 'students' && (
          <div className="teacher-section">
            {students.length === 0 ? (
              <p className="empty-text">Пока нет учеников. Поделитесь кодом приглашения.</p>
            ) : (
