      ...
      {activeTab === 'library' && (
        ...
        {showSettings && (
          <ProfileSettings
            ...
            loginCode={null}
            inviteCode={null}
            initialName={adminProfile?.name || 'Admin'}
            initialAvatar={adminProfile?.avatar_url || null}
            onClose={() => setShowSettings(false)}
            onSaved={(newName, newAvatar) => setAdminProfile({ name: newName, avatar_url: newAvatar })}
